...
public class LongChessView extends Activity {
	...
	public void creatChess()
	{
		BlackChess = new Chess[]{
				new Chess(BLACK,"車",0,0),
				new Chess(BLACK,"馬",1,0),
				new Chess(BLACK,"象",2,0),
				new Chess(BLACK,"士",3,0),
				new Chess(BLACK,"將",4,0),
				new Chess(BLACK,"士",5,0),
				new Chess(BLACK,"象",6,0),
				new Chess(BLACK,"馬",7,0),
				new Chess(BLACK,"車",8,0),
				new Chess(BLACK,"包",1,2),
				new Chess(BLACK,"包",7,2),
				new Chess(BLACK,"卒",0,3),
				new Chess(BLACK,"卒",2,3),
				new Chess(BLACK,"卒",4,3),
				new Chess(BLACK,"卒",6,3),
				new Chess(BLACK,"卒",8,3)};
